...
import { Plus, Wallet, CheckCircle2, Trash2, ChevronDown, AlertTriangle } from "lucide-react";
...
function TxRow({ t, client, onPay, onDelete }: { t: any; client: any; onPay: () => void; onDelete: () => void }) {
    ...
    <div className="glass rounded-xl p-3 md:p-4">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
        ...
        <div className="flex items-center justify-end gap-2 sm:shrink-0">
          ...
          {t.status !== "pago" && (
            <Button size="icon" variant="ghost" onClick={onPay} aria-label="Marcar como pago">
